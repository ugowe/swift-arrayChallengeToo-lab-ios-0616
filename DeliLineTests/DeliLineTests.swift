...
import XCTest
@testable import DeliLine

class DeliLineTests: XCTestCase {
    ...
    func testFirstPersonAddedToDeliLine() {
        ...
        let firstCustomerGreeting = testVC.addNameToDeliLine(name: "Jon Snow")
    ...
    func testBillyCrystalAddedToDeliLine() {
        ...
        let billyCrystalGreeting = testVC.addNameToDeliLine(name: "Billy Crystal")
        let countOfLine = testVC.deliLine.count
    ...
    func testNormalPersonAddedToLineWithPeopleAlreadyOnIt() {
        ...
        let jimGreeting = testVC.addNameToDeliLine(name: "Jim")
        let countOfLine = testVC.deliLine.count
